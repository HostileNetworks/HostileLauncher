...
public class InstanceTableModel extends AbstractTableModel {
    ...
    public InstanceTableModel(InstanceList instances) {
        ...
        instanceIcon = SwingHelper.createIcon(Launcher.class, "instance_icon.png", 96, 64);
        customInstanceIcon = SwingHelper.createIcon(Launcher.class, "custom_instance_icon.png", 96, 64);
        downloadIcon = SwingHelper.createIcon(Launcher.class, "download_icon.png", 96, 64);
    }
